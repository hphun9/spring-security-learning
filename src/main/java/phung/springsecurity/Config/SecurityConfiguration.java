...
//                .withUser("admin")
//                .password("admin").authorities("admin").and()
//                .withUser("user")
//                .password("123456").authorities("read").and()
...
//    }
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        UserDetails userDetails = User.withUsername("admin").password("admin").authorities("admin").build();
        UserDetails userDetails1 = User.withUsername("user").password("user").authorities("read").build();
